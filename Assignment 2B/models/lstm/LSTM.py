...
df_model = pd.read_csv(DATA / 'model_data.csv', dtype={"SCATS Number": str})
...
joblib.dump(scaler_y, MODELS / "lstm_traffic_volume_scaler.pkl")
...
model.save(BASE / f"lstm_traffic_model.keras")